...
class AckermannController(Node):
    def __init__(self, timer_period=0.01, timeout_duration=1e9):
        ...
        self.declare_parameter("body_length", 0.0)
        self.declare_parameter("body_width", 0.0)
        self.declare_parameter("wheel_radius", 0.0)
        self.declare_parameter("wheel_length", 0.0)
        self.declare_parameter("wheel_connector_length", 0.0)
        ...
        self.track_width = self.body_width + (2 * self.wheel_connector_length / 2)
